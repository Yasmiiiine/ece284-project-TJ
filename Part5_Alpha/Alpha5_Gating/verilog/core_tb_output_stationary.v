...
//loop through all of our input channel values 
  ...
  for (ic=0; ic < len_ic ; ic=ic+1) begin  // kij loop
    ...
    case(ic)
     0: begin w_file_name = "weight_ic0.txt"; x_file_name = "activation_ic0.txt"; end
     1: begin w_file_name = "weight_ic1.txt"; x_file_name = "activation_ic1.txt"; end
     2: begin w_file_name = "weight_ic2.txt"; x_file_name = "activation_ic2.txt"; end
     3: begin w_file_name = "weight_ic3.txt"; x_file_name = "activation_ic3.txt"; end
     4: begin w_file_name = "weight_ic4.txt"; x_file_name = "activation_ic4.txt"; end
     5: begin w_file_name = "weight_ic5.txt"; x_file_name = "activation_ic5.txt"; end
     6: begin w_file_name = "weight_ic6.txt"; x_file_name = "activation_ic6.txt"; end
     7: begin w_file_name = "weight_ic7.txt"; x_file_name = "activation_ic7.txt"; end
    endcase
